...
namespace StackOverflow.DAL.Membership.Store
{
    public class CustomRoleStore<TRole> : RoleStoreBase<TRole, Guid, ApplicationUserRole,
      ApplicationRoleClaim> where TRole : ApplicationRole
    {
        private readonly ISession _session;

        public CustomRoleStore(ISession session, IdentityErrorDescriber describer) : base(describer) =>
